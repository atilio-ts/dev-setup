...
> **Note:** Files marked *snapshot* in `claude/` are auto-generated by Claude Code plugins and tracked here for reference only — `setup.sh` does not copy them (plugins recreate them on a new machine).
